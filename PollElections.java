...
public class PollElections {
	...
	public static void main(String[] args) throws Exception
	{
		...
		Job job= new Job(conf, "Poll Elections");
		job.setJarByClass(PollElections.class);
	...
	job.setMapperClass(PollElectionMapper.class);
	job.setReducerClass(PollElectionReducer.class);
